...
- Run `hugo new site <site_name>`. This will create a directory `<site_name>` containing the hugo templates. Pass in the optional `-f yml` option to override the default toml used for configuration. Refer to the [hugo doc](https://gohugo.io/getting-started/quick-start/)
...
![gh-pages branch](../../post1/gh-pages-branch.jpg)
...
![Github Actions permissions](../../post1/actions_permission.jpg)
...
![Github Pages Custom Domain](../../post1/github_pages_custom_domain.jpg#left)
...
![Namecheap DNS Records](../../post1/namecheap_dns_records.jpg#left)
